...
public class IDTests {
  ...
  @Test
  @DisplayName("Tests conversion from GraphQL query empty variables")
  ...
  @Test
  @DisplayName("Tests failure when a query variable is wrong")
  ...
  @Test
  @DisplayName("Tests conversion from GraphQL empty embedded value")
  ...
  @Test
  @DisplayName("Tests failure from GraphQL query with wrong embedded id")
