 ...
 */
@Singleton
public class JooqUserGroupRepository implements UserGroupRepository {
   ...
   * @since 0.1.0
   */
  public JooqUserGroupRepository(DSLContext context) {
  ...
  public List<Group> listGroupsUser(UUID userId) {
    return context
        ...
        .fetch(RecordMapperHelper::toGroup);
  }
  ...
  public UserGroup getUserGroup(UUID userId, UUID groupId) {
    return (UserGroup)
        context
            ...
            .fetchOne(RecordMapperHelper::toUserGroup);
  }
  ...
  public List<UserGroup> listAdminsGroup(UUID groupId) {
    return (List<UserGroup>)
        context
            ...
            .fetch(RecordMapperHelper::toUserGroup);
  }
