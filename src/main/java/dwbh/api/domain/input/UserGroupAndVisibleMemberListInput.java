 ...
 * @since 0.1.0
 */
public class UserGroupAndVisibleMemberListInput {
   ...
   * @since 0.1.0
   */
  public UserGroupAndVisibleMemberListInput(UUID userId, UUID groupId) {
    this.userId = userId;
   ...
   * @since 0.1.0
   */
  public UserGroupAndVisibleMemberListInput(UUID userId, UUID groupId, boolean visibleMemberList) {
    this.userId = userId;
    this.groupId = groupId;
